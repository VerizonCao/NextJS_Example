                ...
                <div className="flex flex-col items-center gap-4 mt-4">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <p className="text-white text-lg lg:text-xl font-medium">Loading character, this will only take a few secods...</p>
                      <p className="font-normal text-neutral-300 text-sm">During Beta-testing, each chat session is limited to 10 minutes.</p>
                    </div>
                  </div>
